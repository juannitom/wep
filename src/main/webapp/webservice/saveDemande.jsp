...
<%
    ...
    String nouveau = mat.nouveauId(mat.getDernier("demande"));
    try {
        DB db = mon.getConnection();
        DBCollection table = db.getCollection("demande");
        BasicDBObject document = new BasicDBObject();
        document.put("_id", nouveau);
        document.put("iddemandeur", request.getParameter("iddemandeur"));
        document.put("iddemande",  request.getParameter("iddemande"));
